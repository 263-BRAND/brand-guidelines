...
function renderSlide(slide, tokens, pages, index, resolvedBg) {
  ...
  if (slide.subtitle) {
    html += '<p style="font-size:' + tokens.typography.sizes.subtitle + ';color:' + subTextColor + ';margin-bottom:32px;">' + esc(slide.subtitle) + '</p>\n';
  }

  html += '<div style="width:60px;height:4px;background:' + lineColor + ';margin-bottom:32px;"></div>\n';
  html += '<div style="font-size:' + tokens.typography.sizes.body + ';color:' + metaColor + ';line-height:1.8;">\n';
  ...
  html += '<div style="position:absolute;bottom:6%;left:6%;font-size:' + tokens.typography.sizes.caption + ';color:' + footColor + ';">\n';

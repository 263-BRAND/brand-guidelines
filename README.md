...
这份技能把品牌 VI 规范、公司信息和业务介绍、和文档标准模板三要素合一，从「人先给 AI 找素材」变成「Agent 能自动摘信息，照着做的规则」。你只负责把需求说清楚，剩下的交给 AI。
...
- **不直接产出 PPTX 版式** — PPT 版式依赖外部设计技能或代码生成，本 Skill 提供的是品牌数据契约
...
各版本更新记录见 [`CHANGELOG.md`](CHANGELOG.md)（新增 / 修复分块，倒序排列）。当前版本：**v1.1.0**（2026-08-25 发布），每次发版会在 [GitHub Releases](https://github.com/263-BRAND/brand-guidelines/releases) 同步发布说明。

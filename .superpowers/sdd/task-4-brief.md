# Task 4: 创建 skills/263-vi.md

## Requirements

创建 `skills/263-vi.md` — Claude Code 平台的 VI 规范 skill 文件。这是用户与 VI 系统的交互入口。
...
1. Create directory `skills/` if it doesn't exist
2. Write the file to `skills/263-vi.md`
3. Commit

## Verification

- File exists at `skills/263-vi.md`
- Frontmatter has `name: 263-vi`
- Contains all sections: 职责, 品牌数据文件, 核心品牌规则, 工作流程, 禁止事项
